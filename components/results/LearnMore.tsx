  ...
  return (
    <div className="bg-gradient-to-br from-indigo-50 to-purple-50 border border-indigo-100 rounded-lg p-5">
      <div className="flex items-center gap-2 mb-3">
        ...
        <h2 className="text-sm font-semibold text-indigo-900">Learn more</h2>
      </div>
      <div className="space-y-2">
        {LEARN_LINKS.map((item) => (
          <Link
            key={item.link}
            href={item.link}
            className="flex items-center justify-between group text-sm text-indigo-700 hover:text-indigo-900 py-1"
          >
